...
export default class PacienteCtrl {
    gravar(requisicao, resposta) {
        ...
        if (requisicao.method === "POST" && requisicao.is("application/json")) {
            ...
            const data_nascimento = dados.data_nascimento || null;
            const endereco = dados.endereco || null;
            const bairro = dados.bairro || null;
            ...
            const cep = dados.cep || null;
            const naturalidade = dados.naturalidade || null;
            const nome_pai = dados.nome_pai || null;
            const nome_responsavel = dados.nome_responsavel || null;
            const nome_mae = dados.nome_mae || null;
            const nome_social = dados.nome_social || null;
            const utilizar_nome_social = dados.utilizar_nome_social || null;
            const religiao = dados.religiao || null;
            const orientacao_sexual = dados.orientacao_sexual || null;
